...
public class DriveTrain extends SubsystemBase {
  ...
  AHRS navGyro = new AHRS(SPI.Port.kMXP);
  ...
  */
  ...
  public Rotation2d getHeading() {
    return Rotation2d.fromDegrees(navGyro.getAngle());
  }

  public double getDegrees() {
    return navGyro.getAngle();
  }
  ...
  public void resetOdometry(Pose2d pose) {
    resetEncoders();
    m_odometry.resetPosition(pose, navGyro.getRotation2d());
  }
